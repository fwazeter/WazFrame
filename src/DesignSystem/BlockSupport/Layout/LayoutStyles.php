<?php
/**
 * LayoutStyles assigns CSS classes or props based on settings attr.
 *
...
class LayoutStyles {
	 ...
	 * @param array          $layout                   Layout object. The one that is passed has already checked the
	 *                                                 existence of default block layout.
